...
namespace DE
{
    ...
    public class DRTest : DataRowBase
    {
        ...
        ///     获取Color32值。
        /// </summary>
        public Color32 Color32Value { get; private set; }
        ...
        ///     获取Quaternion值。
        /// </summary>
        public Quaternion QuaternionValue { get; private set; }
        ...
        ///     获取Vector4值。
        /// </summary>
        public Vector4 Vector4Value { get; private set; }

        /// <summary>
        ///     获取Bool列表。
        /// </summary>
        public List<bool> BoolList { get; private set; }
        ...
        ///     获取Color32列表。
        /// </summary>
        public List<Color32> Color32List { get; private set; }
        ...
        ///     获取DateTime列表。
        /// </summary>
        public List<DateTime> DateTimeList { get; private set; }

        /// <summary>
        ///     获取Decimal列表。
        /// </summary>
        public List<decimal> DecimalList { get; private set; }

        /// <summary>
        ///     获取Double列表。
        /// </summary>
        public List<double> DoubleList { get; private set; }
        ...
        ///     获取Long列表。
        /// </summary>
        public List<long> LongList { get; private set; }

        /// <summary>
        ///     获取Quaternion列表。
        /// </summary>
        public List<Quaternion> QuaternionList { get; private set; }

        /// <summary>
        ///     获取Rect列表。
        /// </summary>
        public List<Rect> RectList { get; private set; }

        /// <summary>
        ///     获取SByte列表。
        /// </summary>
        public List<sbyte> SByteList { get; private set; }

        /// <summary>
        ///     获取Short列表。
        /// </summary>
        public List<short> ShortList { get; private set; }
        ...
        ///     获取UInt列表。
        /// </summary>
        public List<uint> UIntList { get; private set; }

        /// <summary>
        ///     获取ULong列表。
        /// </summary>
        public List<ulong> ULongList { get; private set; }

        /// <summary>
        ///     获取UShort列表。
        /// </summary>
        public List<ushort> UShortList { get; private set; }

        /// <summary>
        ///     获取Vector2列表。
        /// </summary>
        public List<Vector2> Vector2List { get; private set; }

        /// <summary>
        ///     获取Vector3列表。
        /// </summary>
        public List<Vector3> Vector3List { get; private set; }

        /// <summary>
        ///     获取Vector4列表。
        /// </summary>
        public List<Vector4> Vector4List { get; private set; }
        ...
        ///     获取Color32数组。
        /// </summary>
        public Color32[] Color32Array { get; private set; }
        ...
        ///     获取DateTime数组。
        /// </summary>
        public DateTime[] DateTimeArray { get; private set; }

        /// <summary>
        ///     获取Decimal数组。
        /// </summary>
        public decimal[] DecimalArray { get; private set; }
        ...
        ///     获取Quaternion数组。
        /// </summary>
        public Quaternion[] QuaternionArray { get; private set; }

        /// <summary>
        ///     获取Rect数组。
        /// </summary>
        public Rect[] RectArray { get; private set; }

        /// <summary>
        ///     获取SByte数组。
        /// </summary>
        public sbyte[] SByteArray { get; private set; }

        /// <summary>
        ///     获取Short数组。
        /// </summary>
        public short[] ShortArray { get; private set; }
        ...
        ///     获取UInt数组。
        /// </summary>
        public uint[] UIntArray { get; private set; }

        /// <summary>
        ///     获取ULong数组。
        /// </summary>
        public ulong[] ULongArray { get; private set; }

        /// <summary>
        ///     获取UShort数组。
        /// </summary>
        public ushort[] UShortArray { get; private set; }

        /// <summary>
        ///     获取Vector2数组。
        /// </summary>
        public Vector2[] Vector2Array { get; private set; }
        ...
        ///     获取Vector4数组。
        /// </summary>
        public Vector4[] Vector4Array { get; private set; }
